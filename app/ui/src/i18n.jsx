...
const translations = {
  en: {
    ...
    boostUnkWarningCropped: '(showing {shown} of {total}, {pct}% of affected terms)',
    ...
    tooltipMaesNumSteps: 'MAES: maximum number of tokens emitted per audio frame before the decoder is forced to advance in time. Only used when Beam Width is above 1. Default: 2.',
    tooltipMaesExpansionBeta: 'MAES: over-generation budget. Each hypothesis expands its top (Beam Width + this) tokens before adaptive pruning. Larger values consider more alternatives at a small cost. Only used when Beam Width is above 1. Default: 2.',
  ...
  fr: {
    ...
    boostUnkWarningCropped: '(affichage de {shown} sur {total}, {pct}\u00a0% des termes concern\u00e9s)',
    ...
    tooltipMaesNumSteps: "MAES : nombre maximal de jetons \u00e9mis par trame audio avant que le d\u00e9codeur ne soit forc\u00e9 d'avancer dans le temps. Utilis\u00e9 uniquement lorsque la largeur de faisceau est sup\u00e9rieure \u00e0 1. D\u00e9faut : 2.",
    tooltipMaesExpansionBeta: "MAES : budget de surg\u00e9n\u00e9ration. Chaque hypoth\u00e8se \u00e9tend ses (largeur de faisceau + cette valeur) meilleurs jetons avant l'\u00e9lagage adaptatif. Des valeurs plus \u00e9lev\u00e9es examinent plus d'alternatives pour un co\u00fbt faible. Utilis\u00e9 uniquement lorsque la largeur de faisceau est sup\u00e9rieure \u00e0 1. D\u00e9faut : 2.",
    tooltipMaesExpansionGamma: "MAES : seuil d'\u00e9lagage adaptatif (en log-probabilit\u00e9). Les expansions de jetons situ\u00e9es au-del\u00e0 de cet \u00e9cart sous le meilleur candidat sont \u00e9cart\u00e9es. Plus petit = \u00e9lagage plus agressif et d\u00e9codage plus rapide ; plus grand = recherche plus large et approfondie. C'est ce qui fait que la largeur de faisceau s'adapte \u00e0 chaque jeton. Utilis\u00e9 uniquement lorsque la largeur de faisceau est sup\u00e9rieure \u00e0 1. D\u00e9faut : 2.3.",
