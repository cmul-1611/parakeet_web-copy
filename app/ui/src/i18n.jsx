...
const translations = {
  en: {
    ...
    verifyChecklist: 'I read both codes aloud and they match.',
    ...
    persistTranscripts: 'Save transcript history to disk',
    ...
    tooltipAdvancedInfo: 'Displays system memory/heap usage, per-transcription performance metrics (RTF, timings), and detailed audio metadata. Default: off.',
    tooltipVerboseLog: 'Enables the most detailed logging level in the browser devtools console. Useful for debugging or performance analysis. Default: off.',
    ...
    tooltipLiveTranscription: 'Stream transcription as you speak. The model re-runs every few seconds on a sliding window of recent audio. The final transcript still runs once after you stop. Default: off.',
  ...
  fr: {
    ...
    verifyChecklist: 'J\u2019ai lu les deux codes \u00e0 voix haute et ils correspondent.',
    ...
    persistTranscripts: 'Sauvegarder l’historique des transcriptions sur disque',
    ...
    tooltipAdvancedInfo: "Affiche l'utilisation m\u00e9moire, les m\u00e9triques de performance par transcription et les m\u00e9tadonn\u00e9es audio d\u00e9taill\u00e9es. D\u00e9faut : d\u00e9sactiv\u00e9.",
    tooltipVerboseLog: "Active le niveau de log le plus d\u00e9taill\u00e9 dans la console du navigateur. Utile pour le d\u00e9bogage. D\u00e9faut : d\u00e9sactiv\u00e9.",
    ...
    tooltipLiveTranscription: "Transcription en flux pendant que vous parlez. Le mod\u00e8le est relanc\u00e9 toutes les quelques secondes sur une fen\u00eatre glissante. La transcription finale est toujours calcul\u00e9e \u00e0 l'arr\u00eat. D\u00e9faut : d\u00e9sactiv\u00e9.",
