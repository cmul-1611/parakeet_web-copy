...
const translations = {
  en: {
    ...
    tooltipBoostMinp: 'A single min-p gate applied to EVERY boosted phrase, superseding each phrase\'s own gate (the ":WEIGHT:MINP" field and any "*" defaults line). A token is only boosted when its probability is at least this fraction of the model\'s top candidate for that step, e.g. 0.1 = at least 10% as likely. Lower values let boosting reach further down the model\'s ranking (stronger, but can force words the model barely considered); higher values keep it a gentle nudge. Default: 0 (off), so each phrase keeps its own gate (0.2 unless the phrase or list sets one).',
    tooltipBoostDepthScaling: 'How much the boost grows as a phrase progresses: the reward at token depth d of a phrase is weight * (1 + this * (d - 1)), so deeper (more committed) matches earn more, encouraging the decoder to complete a started phrase. 0 gives every token of a phrase the same flat reward; larger values increasingly favour finishing long phrases. Changing it rebuilds the phrase list. Default: 0.5.',
  ...
  fr: {
    ...
    tooltipBoostMinp: 'Une garde min-p unique appliqu\u00e9e \u00e0 CHAQUE phrase renforc\u00e9e, qui remplace la garde propre de chaque phrase (le champ \u00ab\u00a0:POIDS:MINP\u00a0\u00bb et toute ligne de d\u00e9fauts \u00ab\u00a0*\u00a0\u00bb). Un jeton n\'est renforc\u00e9 que si sa probabilit\u00e9 atteint au moins cette fraction du meilleur candidat du mod\u00e8le \u00e0 cette \u00e9tape, ex.\u00a0: 0.1 = au moins 10\u00a0% aussi probable. Des valeurs plus basses laissent le renforcement descendre plus loin dans le classement du mod\u00e8le (plus fort, mais peut forcer des mots que le mod\u00e8le n\'envisageait gu\u00e8re)\u00a0; des valeurs plus hautes le gardent en simple coup de pouce. D\u00e9faut\u00a0: 0 (d\u00e9sactiv\u00e9e), chaque phrase garde alors la sienne (0.2 sauf indication de la phrase ou de la liste).',
    tooltipBoostDepthScaling: '\u00c0 quel point le renforcement cro\u00eet \u00e0 mesure qu\'une phrase progresse\u00a0: la r\u00e9compense au jeton de profondeur d d\'une phrase vaut poids * (1 + cette valeur * (d - 1)), donc les correspondances plus avanc\u00e9es rapportent davantage, ce qui encourage le d\u00e9codeur \u00e0 terminer une phrase commenc\u00e9e. 0 donne \u00e0 chaque jeton d\'une phrase la m\u00eame r\u00e9compense fixe\u00a0; des valeurs plus grandes favorisent de plus en plus l\'ach\u00e8vement des phrases longues. Modifier cette valeur reconstruit la liste de phrases. D\u00e9faut\u00a0: 0.5.',
